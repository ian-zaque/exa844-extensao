...
class AuthController extends Controller {
    ...
    /**
     * Método que retorna o usuário autenticado.
     *
     * @return \Illuminate\Http\JsonResponse
     */
     ...
     * Método que retorna o array estruturado do token.
     *
     * @param  string $token
     *
     * @return \Illuminate\Http\JsonResponse
    ...
    protected function createNewToken($token){
        $user = User::with(['user_role'])->where('id','=',auth()->user()->id)->first();
        $dadosUser = auth()->user();
        $dadosUser->role = $user->user_role;
